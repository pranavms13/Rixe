...
# Create monero user
RUN adduser --system --group --disabled-password rixe && \
	mkdir -p /wallet /home/rixe/.rixe && \
	chown -R rixe:rixe /home/rixe/.rixe && \
	chown -R rixe:rixe /wallet

# Contains the blockchain
VOLUME /home/rixe/.rixe
...
ENTRYPOINT ["rixed", "--p2p-bind-ip=0.0.0.0", "--p2p-bind-port=16999", "--rpc-bind-ip=0.0.0.0", "--rpc-bind-port=16998", "--non-interactive", "--confirm-external-bind"]
